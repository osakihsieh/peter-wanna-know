#!/usr/bin/env python3
"""Run the v3 verification bundle for peter-wanna-know."""
        ...
        [
            ...
            *subprocess.run(
                [
                    "rg",
                    "--files",
                    "skills/peter-wanna-know/scripts",
                    "tests",
                    "-g",
                    "*.py",
                    "-g",
                    "!skills/peter-wanna-know/scripts/lib/vendor/**",
                ],
                cwd=REPO_ROOT,
                text=True,
                capture_output=True,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="/tmp/peter-wanna-know-v3-verify")
