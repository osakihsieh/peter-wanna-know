#!/usr/bin/env python3
"""Morning briefing generator for peter-wanna-know.
...
BRIEFS_DIR = Path.home() / ".local" / "share" / "peter-wanna-know" / "briefs"
...
def generate_daily(since: str = None) -> dict:
    ...
    if not topics:
        return {
            "status": "no_topics",
            "message": "No watchlist topics yet. Add one with: peter-wanna-know watch add \"your topic\"",
        }
...
def main():
    parser = argparse.ArgumentParser(description="Generate peter-wanna-know briefings")
