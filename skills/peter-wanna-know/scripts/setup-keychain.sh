#!/bin/bash
# Store peter-wanna-know API keys in the macOS Keychain.
#
# Keys are stored as generic passwords with service name `peter-wanna-know-<KEY>`
...
#   ./setup-keychain.sh --list       # list which peter-wanna-know-* items exist
...
case "$ACTION" in
  list)
    echo "Stored peter-wanna-know-* keychain items:"
