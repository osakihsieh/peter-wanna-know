#!/usr/bin/env python3
"""SQLite research accumulator for peter-wanna-know.
...
Database location: ~/.local/share/peter-wanna-know/research.db
"""
...
DB_DIR = Path.home() / ".local" / "share" / "peter-wanna-know"
...
def main():
    parser = argparse.ArgumentParser(description="Query the peter-wanna-know research database")
