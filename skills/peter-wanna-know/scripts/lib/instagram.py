"""Instagram Reels search via ScrapeCreators API for /peter-wanna-know.
...
def _resolve_transcript_timeout(
    ...
    LAST30DAYS_STORE in peter-wanna-know.py so the env var works whether it's
    shell-exported or set in ~/.config/peter-wanna-know/.env.
    """
