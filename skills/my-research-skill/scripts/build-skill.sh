...
# Usage: bash skills/peter-wanna-know/scripts/build-skill.sh  (run from repo root)
#
# Produces dist/peter-wanna-know.skill, a zip with a single top-level `peter-wanna-know/`
# directory containing SKILL.md and the scripts/ runtime from skills/peter-wanna-know.
# See
...
mkdir -p dist
OUT="dist/peter-wanna-know.skill"
git archive --format=zip --prefix=peter-wanna-know/ --output="$OUT" HEAD:skills/peter-wanna-know
